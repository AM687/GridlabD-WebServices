...
std::auto_ptr< ::microturbine_server > pmicroturbine_server(::staff::ServiceFactory::Inst().GetService< ::microturbine_server >());
...
int micro_service::init(OBJECT *parent)
{
	...
	double microturbine_initResult = pmicroturbine_server->microturbine_init();
	printf("microturbine_initResult = %f \n", microturbine_initResult);

	//test return
	price = microturbine_initResult;
...
TIMESTAMP micro_service::sync(TIMESTAMP t0, TIMESTAMP t1) 
{
	...
	//CircuitA_V_Out_re=pCircuit_V_A[0].Re(),
	//CircuitA_V_Out_im=pCircuit_V_A[0].Im(), 
	//CircuitB_V_Out_re=pCircuit_V_B[0].Re(), 
	// CircuitB_V_Out_im=pCircuit_V_B[0].Im(),
	//CircuitC_V_Out_re=pCircuit_V_C[0].Re(),
	//CircuitC_V_Out_im=pCircuit_V_C[0].Im(),
	//LineA_V_Out_re=pLine_I_A[0].Re(), 
	//LineA_V_Out_im=pLine_I_A[0].Im(), 
	//LineB_V_Out_re=pLine_I_B[0].Re(), 
	//LineB_V_Out_im=pLine_I_B[0].Im(),
	//LineC_V_Out_re=pLine_I_C[0].Re(), 
	//LineC_V_Out_im=pLine_I_C[0].Im()
    ...
    double microturbine_syncResult = pmicroturbine_server->microturbine_sync(CircuitA_V_Out_re, CircuitA_V_Out_im, CircuitB_V_Out_re, CircuitB_V_Out_im, CircuitC_V_Out_re, CircuitC_V_Out_im, LineA_V_Out_re, LineA_V_Out_im, LineB_V_Out_re, LineB_V_Out_im, LineC_V_Out_re, LineC_V_Out_im);
